package epam.advanced.task01.path1.house;

import epam.advanced.task01.path1.residents.cats.Cat;
import epam.advanced.task01.path1.residents.cats.Kitten;
import epam.advanced.task01.path1.residents.dogs.Dog;
import epam.advanced.task01.path1.residents.dogs.Puppy;
