...
salary are set)
·       abstract method setBonus that sets bonuses to salary, amount of which is
...
constructor
·       Redefine abstract method of parent class setBonus in the following way: if the
...
public class Program {
    public static void main(String[] args) {
        Company company = new Company(new Employee[]{
                new SalesPerson("Taras", new BigDecimal(5000), 120),
                new SalesPerson("Den", new BigDecimal(4000), 163),
                new Manager("Alica", new BigDecimal(9000), 90)
        });
        company.giveEverbodyBonus(new BigDecimal(100));

        System.out.println(company.totalToPay());
        System.out.println("name max salary: " + company.nameMaxSalary());
    }
}
